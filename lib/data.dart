...
List<Game> games2 = [
  ...
  Game(
    ...
    GameImage("https://m.media-amazon.com/images/I/71G1RvDnMYL._AC_UF894,1000_QL80_.jpg", ""),
    "",
    "Naughty Dog",
  ),
  Game(
    "EA Cricket 07",
    GameImage(
        "https://www.gamespot.com/a/uploads/scale_medium/mig/0/7/1/3/2220713-cricket.jpg",
        ""),
    "",
    "From EA",
  ),
  Game(
    "PUBG",
    GameImage(
        "https://wallpapers.com/images/hd/playerunknowns-battlegrounds-logo-v5z0ffor8qrnj33g.jpg",
        ""),
    "",
    "From EA",
  ),
...
List<Game> featuredGames = [
  ...
  Game(
    ...
    GameImage(
        "https://i.ytimg.com/vi/kGhegZ4eCGY/maxresdefault.jpg",
        ""),
    "",
    "CyberConnect2",
  ),
